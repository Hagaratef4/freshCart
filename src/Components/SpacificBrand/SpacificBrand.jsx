        ...
        <>
            <div className="container my-6">
                    <div className="xl:mx-44">
                        ...
                        <Link
                        to={'/categories'}
                        className="cursor-pointer rounded-full p-1.5 ease-in  mx-5 hover:bg-darkPrimary bg-primary text-center text-white">
